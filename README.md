...
Xbox One Controller support has been removed to allow for compatibility with xone.
...
sudo git clone https://github.com/forkymcforkface/xpad-noone.git /usr/src/xpad-0.4
